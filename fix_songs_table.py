#!/usr/bin/env python3
"""
Fix the songs table schema by recreating it with proper validation columns.
"""
...
def fix_songs_table() -> None:
    ...
    backup_path = f"jamanager_backup_{datetime.now().strftime('%Y%m%d_%H%M%S')}.db"
    ...
    try:
        ...
        print("Fixing songs table schema...")

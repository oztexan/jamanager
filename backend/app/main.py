...
from app.core.user_roles import UserRoleManager, get_current_user_role
...
from app.core.feature_flag_config import get_feature_flag_value
from app.core.feature_flag_api_simple import router as feature_flag_router
from app.core.access_config import AccessConfig, jam_manager_sessions
from app.core.jam_config import JamConfig
from app.core.slug_utils import generate_jam_slug, make_slug_unique
from app.core.image_utils import ImageUploader
...
from app.models.database import Song, Jam, JamSong, Attendee, Vote, PerformanceRegistration, Venue, SongInDB, JamInDB, SongCreate, SongUpdate, VenueInDB, VenueCreate, VenueUpdate, JamInDBWithVenue
...
from app.services.chord_sheet_api import router as chord_sheet_router
...
async def read_index():
    ...
    if not os.path.exists(index_path):
        ...
        alt_paths = ["static/index.html", "app/static/index.html", "../app/static/index.html"]
...
async def jam_page(slug: str):
    """Serve the jam page"""
    return FileResponse("app/static/jam.html")

@app.get("/songs")
async def songs_page():
    """Serve the songs page"""
    return FileResponse("app/static/songs.html")

@app.get("/jams")
async def jams_page():
    """Serve the jams page"""
    return FileResponse("app/static/jams.html")

@app.get("/jam-manager")
async def jam_manager_page():
    """Serve the jam manager page"""
    admin_path = "app/static/admin.html"
    ...
    if not os.path.exists(admin_path):
        ...
        # Try alternative paths
        alt_paths = ["static/admin.html", "app/static/admin.html", "../app/static/admin.html"]
        for alt_path in alt_paths:
            logger.info(f"Checking alternative path: {alt_path} - exists: {os.path.exists(alt_path)}")
...
async def jam_manager_feature_flags():
    ...
    return FileResponse("app/static/feature-flags.html")

@app.get("/jam-manager/venues")
async def venue_management_page():
    """Venue management interface"""
    return FileResponse("app/static/venue-management.html")
